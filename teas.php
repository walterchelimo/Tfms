        ...
        <div class="row mt-5 mb-5" style="width:80%; margin-left:auto;margin-right:auto;">
            ...
            <div class="col">
                <div class="card" style="border:none;">
                    <div class="body">
                        <h4>Black CTC Tea</h4><hr>
                        <p>
                       Black CTC is oxidized tea manufactured through cutting, tearing and curling machine.<br><br>

                Grading is through separation of particle sizes using various meshes.<br><br>

                Black CTC tea includes:<br><br>
                            1.Broken Pekoe 1 – Largest size of ‘grain’ particles and it produces liquors that are a bit light in body but with encouraging flavoring characteristics.<br><br>
                            2.Pekoe Fanning 1 – Black and grainy with particles slightly smaller in size than those of the BP1 grade.<br><br>
                            3.Dust – Its made up of the smallest particles of main grades.<br><br>
                            4.Pekoe Dust – Black and finer than the Pekoe Fanning 1. It produces thick more pungent liquors.<br><br>
                        </p>
