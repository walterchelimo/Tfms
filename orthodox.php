...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html">Tea Factory</a></h1>
          ...
          <li><a href="index.php">Home</a></li>
           <li class="dropdown"><a href="#"><span>About Us</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                  ...
                  <li><a href="management.php">Senior Management</a></li>
                </ul>
              </li>
           
                <li><a class="active" href="teas.php">Our Teas</a></li>
    ...
    <div class="head p-3" style="background-color:forestgreen;font-size:35px; text-align:center; font-weight:2000;color:white;">
        ...
        <div class="row mt-5 mb-5" style="width:80%; margin-left:auto;margin-right:auto;">
            <div class="col-3">
                <h4>Our Teas</h4><hr>
                <div>
                <a style="color:black;" href="teas.php">Black CTC Tea</a>
                    </div>
                <div>
                <a style="color:black;" href="orthodox.php">Black Orthodox Tea</a>
                </div>
                <div>
                <a style="color:black;" href="green.php">Green Tea</a>
            </div>
            ...
            <div class="col">
                <div class="card" style="border:none;">
                    <div class="body">
                        <h4>Black Orthodox Tea</h4><hr>
                        <p>
                        Black orthodox is oxidized tea produced through rolling machines.<br><br>

                Black Orthodox grading is by leaf size, texture and style.<br><br>

                Black Orthodox tea includes:<br><br>
                            1.Orange Pekoe A – Well rolled & curled, loosely wound, leggy, stylish for the grade, largest whole leaf grade.<br><br>
                            2.Orange Pekoe 1 – Stylish, wiry well made whole leaf tea, tightly twisted depicting a high quality with food bloom.<br><br>
                            3.Flowery Orange Fanning – Leafy, heavy, evenly sized Orthodox finings tea with good bloom and the occasional tip, very suitable for tea bags.<br><br>
                            4.Flowery Broken Orange Pekoe Fanning – Short, well & evenly sized flowery broken orange pekoe tea with the occasional tip.<br><br>
                        </p>
