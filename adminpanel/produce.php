...
if(isset($_POST['add'])){
    ...
    $sql="INSERT INTO produce(id,factoryid,payrates,weight,dtpay,date)VALUES('$id','$factoryid','$payrates','$weight','$dtpay','$date')";
    $results=mysqli_query($conn,$sql);
...
?>
                                        ...
                                        if($_POST) {
                                            if(
                                           floatval( $payrates = $_POST['payrates']) and
                                            floatval($weight = $_POST['weight'])) {
                                                ...
                                                $result = round(($payrates * $weight), 2);
            ...
            <div class="row p-2">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="float" name="payrates" value="60">
                                </div>
                            </div>
            ...
            <div class="row p-2">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="float" name="weight" value='<?php echo $weight; ?>' placeholder="insert the weight here" required>
                                </div>
                            </div>
            
            <div class="row p-1">
                                <div class="col-md-2">
                                    <input style="background-color:orange; color:white;" class="form-control" type="submit" name="calculate" value='CALCULATE'>
                                </div>
                            </div>
            ...
            <div class="row p-2">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="float" name="dtpay" value='<?php echo $res; ?>'>
                                </div>
                            </div>
            ...
            <div class="row p-2">
                                <div class="col-md-12">
                                    <label class="form-label grey">Farmer Id</label>
                                    <select class=form-control name="factoryid">
                                        <option value="<?php $row['factoryid'] ?>">
                                            select Farmer
                                        </option>
                                        <?php
                                        ...
                                        while($row = mysqli_fetch_array($sql) ){
                                            ?>
                                            <option value="<?php echo $row['factoryid']; ?>  "><?php echo $row['factoryid']." ".$row['sname']." ".$row['lname']; ?> </option>
                                            <?php
                                            }
                                         ?>
                                                                </select>
