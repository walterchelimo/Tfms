                 ...
                 <form action="add_farmer.php" method="post" enctype="multipart/form-data">
                     ...
                     <div class="row m-1">
                         ...
                         <div class="col">
                             ...
                             <div>
                             <input class="col-12 p-2" style="border:1px solid green; border-radius:6px;" type="text" name="factoryid" required>
                                 </div>
                         </div>
                     </div>
                     ...
                     <div class="row m-1">
                         <div class="col">
                             ...
                             <div>
                             <input class="col-12 p-2" style="border:1px solid green; border-radius:6px;" type="tel" name="pnumber" required>
                                 </div>
                         </div>
                         <div class="col">
                             <div>
                     ...
                     <div class="row m-1">
                         <div class="col">
                             ...
                             <div>
                             <input class="col-12 p-2" style="border:1px solid green; border-radius:6px;" type="file" name="profile" required>
                                 </div>
                         </div>
                         <div class="col">
                             <div>
                      ...
                      <div class="row m-1">
                         ...
                         <div class="col">
                             ...
                             <div>
                             <select name="password" class="col-12 p-2" style="border:1px solid green; border-radius:6px;">
