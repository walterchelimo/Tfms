...
if (isset($_POST["update"])) {
    ...
    $up_sql = "UPDATE `tenders` SET  `tender`='$up_tender',`dos`='$up_dos',`tenderfile`='$tenderfile' WHERE id ='$id'";
    ...
    if ($up_result){
        ...
        echo "<p class='alert alert-success'>Tender have been updated!</p>";
        echo "<a class='btn btn-primary col-md-4' href='editt.php'>BACK</a>";
        echo "</div>";
    ...
    <div class="card">
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row p-2">
                    <div class="col-md-12">
                        <label class="form-label grey">Tender</label>
                        <input class="form-control" type="text" name="tender" value="<?php echo $tender; ?>">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-md-12">
                        <label class="form-label grey">Date Of Submission</label>
                        <input class="form-control" type="date" name="dos" value="<?php echo $dos; ?>">
                    </div>
                </div>
                <div class="row p-2">
                                    <div class="col-md-12">
                                        <label class="form-label grey">Upload Tender File</label>
                                        <input class="form-control" type="file" name="tenderfile" value="<?php echo $tenderfile; ?>">
                ...
                <div class="row p-2">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-danger" href="editt.php">BACK</a>
