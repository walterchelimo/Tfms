        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="../uploads/<?php echo $photo?>" alt="Profile" class="rounded-circle" style="width:150px; height:130px;">
...
if (isset($_POST["update"])) {
    ...
    $up_sql = "UPDATE `users` SET  `fname`='$fname',`sname`='$sname',`lname`='$lname',
                    `email`='$email',`pnumber`='$pnumber',`profile`='$profile',`bankname`='$bankname',`bankbranch`='$bankbranch',`accountnumber`='$accountnumber',`accountname`='$accountname' WHERE email ='$email'";
